              ...
              appBar: AppBar(
                ...
                title: Row(
                  ...
                  children: [
                    ...
                    Text(
                      '${cons.clock[3]}${cons.clock[2]} : ${cons.clock[1]}${cons.clock[0]}',
                      style: Theme.of(context).textTheme.titleSmall!.copyWith(
                            fontWeight: FontWeight.bold,
                            color: AppColors.white,
                          ),
                ...
                child: Column(
                  children: [
                    Selector<TriTueLogic, Tuple2<Map<String, dynamic>?, int>>(
                      selector: (p0, p1) =>
                          Tuple2(p1.dataCauHoi, p1.countCauHoi),
                          ...
                          return Column(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  'Thời gian đã chơi: ${cons.clock[3]}${cons.clock[2]} : ${cons.clock[1]}${cons.clock[0]}',
                                  style: Theme.of(context)
                                      .textTheme
                                      .bodyLarge!
                                      .copyWith(
